...
public static class SeedDataBuilderExtensions
{
    ...
    {
        return app.UseMiddleware<SeedActivityMiddleware>();
    }
}
public class SeedActivityMiddleware(RequestDelegate next, ILogger<SeedActivityMiddleware> logger)
{
    public async Task InvokeAsync(HttpContext context)
    {
        using (var scope = context.RequestServices.CreateScope())
        {
            logger.LogInformation("About to seed data");
    ...
    private static async Task SeedData(ApplicationContext dbContext)
    {
