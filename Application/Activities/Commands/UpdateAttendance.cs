...
public static class UpdateAttendance
{
    ...
    public class Handler(ApplicationContext context, IUserAccessor userAccessor) : IRequestHandler<Command, Result<Unit>>
    {
        public async Task<Result<Unit>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var attendance =
                activity.Attendees.FirstOrDefault(x => x.UserId == user.Id);
